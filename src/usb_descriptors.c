...
acm_config_desc_t self_config_desc = {
    .self_config_desc = {
        .bLength = sizeof(acm_config_desc_t),
    ...
    .cdc_union = {
        .bLength = sizeof(usb_cdc_union_func_desc_t),
        .bDescriptorType = USB_CDC_DESC_CS_INTERFACE,
    ...
    .mgmt_ep = {
        ...
        .wMaxPacketSize = 64,
        .bInterval = 0 // not an isochronous ep
    },
    /*
     *.notification_ep = {
     *    .bLength = sizeof(usb_endpoint_desc_t),
    ...
    .bulk_in = {
        .bLength = sizeof(usb_endpoint_desc_t),
        .bDescriptorType = USB_DESC_ENDPOINT,
        .bEndpointAddress = (1 | USB_EP_DIR_IN),
    ...
    .bulk_out = {
        .bLength = sizeof(usb_endpoint_desc_t),
        .bDescriptorType = USB_DESC_ENDPOINT,
        .bEndpointAddress = (2 | USB_EP_DIR_OUT),
        .bmAttributes = USB_EP_ATTRS_BULK | USB_EP_ATTRS_NO_SYNC | USB_EP_ATTRS_DATA,
        .wMaxPacketSize = 64,
        .bInterval = 0
    }
